...
//   glEnable( GL_CULL_FACE );
  ...
  GLfloat col4[] = {0.2f, 0.2f, 0.2f, 0.2f};

  glEnable(GL_LIGHT0);    
  glLightfv(GL_LIGHT0,GL_POSITION, pos1);
  glLightfv(GL_LIGHT0,GL_DIFFUSE,  col1);
  //glLightfv(GL_LIGHT0,GL_SPECULAR, col1);
  glLightfv(GL_LIGHT0,GL_SPECULAR, col4);
  
  glEnable(GL_LIGHT1);  
  glLightfv(GL_LIGHT1,GL_POSITION, pos2);
  glLightfv(GL_LIGHT1,GL_DIFFUSE,  col2);
  //glLightfv(GL_LIGHT1,GL_SPECULAR, col2);
  glLightfv(GL_LIGHT1,GL_SPECULAR, col4);

  glEnable(GL_LIGHT2);  
  glLightfv(GL_LIGHT2,GL_POSITION, pos3);
  glLightfv(GL_LIGHT2,GL_DIFFUSE,  col3);
  //glLightfv(GL_LIGHT2,GL_SPECULAR, col3);
  glLightfv(GL_LIGHT2,GL_SPECULAR, col4);
...
GlutExaminer::keyboard(int key, int x, int y) 
{
  switch (key)
  {
    case 'f':
    {
      std::cerr<<std::endl<<"Performance test: ";
